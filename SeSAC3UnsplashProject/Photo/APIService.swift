...
class APIService {
    ...
    func randomImageAPIRequest(completionHandler: @escaping (RandomPhoto?) -> Void) {
        guard let url = URL(string: "https://api.unsplash.com/photos/random?client_id=\(unsplashAccessKey)") else { return }
